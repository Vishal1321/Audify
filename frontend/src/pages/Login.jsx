            ...
            <div className="w-[72%] h-[100%]  bg-green-200 bg-opacity-60 rounded-2xl shadow-[2px_2px_30px_rgba(66,57,238,0.2)] flex items-center justify-center relative overflow-hidden bg-cover bg-center" >
                ...
                <div className="w-1/2  bg-green-200 flex flex-col items-center mt-8 max-[1080px]:w-full">
                    ...
                    {[
                        ...
                        <div key={i} className="w-[350px] h-[50px] rounded-full bg-white shadow-[2px_6px_18px_rgba(66,57,238,0.3)] flex items-center justify-start px-4 my-2 max-[500px]:w-[300px] max-[420px]:w-[280px]">
                            <img src={input.icon} alt="icon" className="h-5 mr-4" />
                            <input
                                  name={input.name}
                                type={input.type}
                                placeholder={input.placeholder}
                                className="w-full h-full outline-none border-none text-sm bg-white"
                ...
                <div className="w-1/2   h-full flex flex-col justify-center items-center text-center px-8 max-[1080px]:hidden">
                    <h1 className="text-[#2D2C2C] text-lg font-bold mb-2">Glad To See You Again!</h1>
                    <p className="text-sm  font-normal text-gray-700">
                        Welcome back, please fill in the blanks for Login
                    </p>
                </div>
            </div>
        </div>
